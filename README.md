...
Name repository: Choose a clear, descriptive name
Add description: Provide a brief summary of the project's purpose
Choose visibility: Select between public or private
Initialize with README: Option to create an initial README file
Add .gitignore: Select a template for ignoring unnecessary files based on your project type
Choose license: Select an appropriate license for your code
Create repository: Finalize by clicking "Create repository"
Clone locally: Clone the repository to your local machine to begin work
...
Project title and description: Clear identification of what the project does
...
Dependencies: Required software, libraries, or tools
Configuration: How to configure the project for different environments
...
Status information: Current state of the project (active, maintained, deprecated)
Visual aids: Screenshots, diagrams, or GIFs demonstrating functionality
Badges: Status indicators for builds, test coverage, etc.
...
Copygit add filename.ext    # For specific files
git add .               # For all changes

Create the commit with a descriptive message:
Copygit commit -m "Add clear description of changes made"
...
ForkingCloningCreates a copy on GitHub server under your accountCreates a local copy on your computerMaintains a reference to the original repositoryNo built-in connection to original repositoryAllows you to propose changes to repositories you don't have write access toTypically used when you already have write accessGitHub-specific featureStandard Git operationCreates a new repository URLUses the same repository URLDone through GitHub interfaceDone via command line or Git clientIncludes all branches, tags, and historyCan be full or partial (shallow clone)
...
Using existing projects as starting points:
...
Handle binary and large files properly:
